...
public class Ecran extends JFrame{
	...
	public Ecran(Partie unePartie){
		...
		ImageIcon imgBack = new ImageIcon("data/background.png");
	...
	/**
	 * La methode pour editer le buffer d'image des serpents
	 * 
	 * @param unNUM Le numero du serpent 
	 * @param X L'abscisse de la position du tete de serpent 
